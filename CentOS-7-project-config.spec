...
Preinstall: libgcc m4 ncurses pam file-libs libdb
...
Preinstall: perl-constant audit-libs libcap-ng
Preinstall: perl-Exporter perl-Getopt-Long perl-Digest-MD5
Preinstall: perl-Data-Dumper perl-Carp
#perl-Digest-SHA
# chkconfig provides update-alternatives needed for ld
Preinstall: chkconfig

#Runscripts: setup

VMinstall: util-linux perl-libs device-mapper libblkid libuuid libmount

FileProvides: /usr/bin/cmp diffutils
FileProvides: /usr/bin/rename util-linux
FileProvides: /usr/bin/ruby ruby

Required: autoconf automake binutils bzip2 gcc gdbm gettext glibc
Required: perl perl-constant perl-Carp perl-Data-Dumper perl-Exporter perl-Getopt-Long perl-Digest-MD5
Required: libtool ncurses zlib rpm-build centos-release redhat-rpm-config gcc-c++
Keep: autoconf automake binutils bzip2 gcc gdbm gettext glibc
Keep: perl perl-constant perl-Carp perl-Data-Dumper perl-Exporter perl-Getopt-Long perl-Digest-MD5
